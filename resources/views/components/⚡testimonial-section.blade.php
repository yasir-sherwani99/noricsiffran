                                    ...
                                    <div class="testimonial-header">
                                        <div class="author-image">
                                            <figure class="image-anime">
                                                <img src="{{ asset('assets/images/author-1.jpg') }}" alt="Nordicsiffran" />
                                            </figure>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">	
                                    <div class="testimonial-header">
                                        <div class="author-image">
                                            <figure class="image-anime">
                                                <img src="{{ asset('assets/images/author-2.jpg') }}" alt="Nordicsiffran" />
                                            </figure>
                                        </div>
                                        <div class="author-content">
                                            <h2>banson doe</h2>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">	
                                    <div class="testimonial-header">
                                        <div class="author-image">
                                            <figure class="image-anime">
                                                <img src="{{ asset('assets/images/author-3.jpg') }}" alt="Nordicsiffran" />
                                            </figure>
                                        </div>
                                        <div class="author-content">
                                            <h2>arita banson</h2>
