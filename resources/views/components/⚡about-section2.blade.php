                ...
                <div class="page-about-image">
                    ...
                    <div class="about-img-1">
                        <figure class="image-anime reveal">
                            <img src="{{ asset('assets/images/new/page-about-1.jpg') }}" alt="Nordicsiffran" />
                        </figure>
                    </div>
                    <!-- About Image End -->
                    ...
                    <div class="about-img-2">
                        <figure class="image-anime reveal">
                            <img src="{{ asset('assets/images/new/page-about-2.jpg') }}" alt="Nordicsiffran" />
                        </figure>
                    </div>
                    <!-- About Image End -->
                    ...
                    <div class="satisfied-client">
                        <div class="satisfied-client-icon">
                            <img src="{{ asset('assets/images/icon-satisfied-client.svg') }}" alt="Nordicsiffran" />
                        </div>
                ...
                <div class="about-content">
                    ...
                    <div class="about-content-footer">
                        ...
                        <div class="about-company-service wow fadeInUp" data-wow-delay="0.5s">
                            <div class="icon-box">
                                <img src="{{ asset('assets/images/icon-company-service-1.svg') }}" alt="Nordicsiffran" />
                            </div>
                        ...
                        <div class="about-company-service wow fadeInUp" data-wow-delay="0.75s">
                            <div class="icon-box">
                                <img src="{{ asset('assets/images/icon-company-service-2.svg') }}" alt="Nordicsiffran" />
                            </div>
                            <div class="company-service-content">
