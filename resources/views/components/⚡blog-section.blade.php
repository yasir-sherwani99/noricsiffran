        ...
        <div class="row">
                ...
                <div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
                    ...
                    <div class="post-featured-image">
                        <figure class="image-anime">
                            <a href="#"><img src="{{ Vite::asset('resources/images/post-1.jpg') }}" alt="Noricsiffran" /></a>
                        </figure>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="blog-item wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="post-featured-image">
                        <figure class="image-anime">
                            <a href="#"><img src="{{ Vite::asset('resources/images/post-2.jpg') }}" alt="Noricsiffran" /></a>
                        </figure>
                    </div>
                    <!-- Post Featured Image End -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="blog-item wow fadeInUp" data-wow-delay="0.75s">
                    ...
                    <div class="post-featured-image">
                        <figure class="image-anime">
                            <a href="#"><img src="{{ Vite::asset('resources/images/post-3.jpg') }}" alt="Noricsiffran" /></a>
                        </figure>
                    </div>
                    <!-- Post Featured Image End -->
