...
Route::get('/sitemap.xml', function () {
    ...
    $pages = [
        ...
        '/about',
        '/services',
        '/service/bookkeeping-and-ongoing-accounting',
        '/service/banking-and-payment-flows',
        '/service/invoicing-and-customer-flows',
        '/service/tax-and-declarations',
        '/service/year-end-closing-and-annual-reports',
        '/service/starting-restructuring-and-closing-a-business',
        '/automation',
        '/pricing',
        '/faqs',
        '/contact',
